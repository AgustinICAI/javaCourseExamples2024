...
public class App
{
    ...
    public static void main(String[] args)
    {
        ...
        do
        {
            opcionAgenda = App.menu(agenda.getNombre());
            App.limpiar();
    ...
    static OpcionAgenda menu(String nombre)
    {
        System.out.println("################################");
        ...
        for(int i = 1; i < OpcionAgenda.values().length; i++)
            ...
            System.out.println("################################");
        System.out.print("  > ");
        int opcion = Integer.parseInt(Leer.porTeclado());
        if(opcion >= OpcionAgenda.values().length || opcion < 0)
            opcion = 0;
        return OpcionAgenda.values()[opcion];
    }
